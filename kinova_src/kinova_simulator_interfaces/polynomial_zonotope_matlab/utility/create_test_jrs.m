...
if ~exist('../dynamics-dev/dynamics/rnea/polynomial_zonotope/jrs_saved', 'dir')
    mkdir('../dynamics-dev/dynamics/rnea/polynomial_zonotope/jrs_saved');
end

% save vector of initial velocity subinterval centers
save('../dynamics-dev/dynamics/rnea/polynomial_zonotope/jrs_saved/c_kvi.mat', 'c_kvi');
...
for j = 1:n_JRS
    ...
    filename = sprintf('../dynamics-dev/dynamics/rnea/polynomial_zonotope/jrs_saved/JRS_%0.3f.mat', current_c_kvi);
