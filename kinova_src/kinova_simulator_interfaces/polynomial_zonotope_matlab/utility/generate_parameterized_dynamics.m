...
if ~exist('../dynamics-dev/dynamics/rnea/polynomial_zonotope/jrs_dynamics', 'dir')
   mkdir('../dynamics-dev/dynamics/rnea/polynomial_zonotope/jrs_dynamics')
end
...
dyn_zero_to_t_plan = matlabFunction(dx, 'File', '../dynamics-dev/dynamics/rnea/polynomial_zonotope/jrs_dynamics/dyn_zero_to_t_plan', 'vars', {x, udummy});
...
dx = [dcqi; dsqi; ddqi; dkai; dkvi; dt];
dyn_t_plan_to_t_total = matlabFunction(dx, 'File', '../dynamics-dev/dynamics/rnea/polynomial_zonotope/jrs_dynamics/dyn_t_plan_to_t_total', 'vars', {x, udummy});
