...
robot_params.num_q = 7;
robot_params.num_joints = 8;
...
cosq = sym('cq', [robot_params.num_q, 1], 'real');
sinq = sym('sq', [robot_params.num_q, 1], 'real');
...
F = sym('F', [robot_params.num_joints,3], 'real');
F = F';
N = sym('N', [robot_params.num_joints,3], 'real');
N = N';
